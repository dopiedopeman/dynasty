...
<div class="constitution">
   <h1 class="noUnderscore">JEDEN VERDAMMTEN SONNTAG LEAGUE CONSTITUTION</h1>
    ...
    <hr />
     ...
     <p>Diese Jeden Verdammten Sonntag Fantasy League Constitution stellt eine Vereinbarung zwischen den Managern dar. Von diesen akzeptiert jeder die Regeln und Rechte dieser Vereinbarung und verpflichtet sich, alle Bedingungen zu akzeptieren und zu befolgen. Die Constitution bleibt auf unbestimmte Zeit in Kraft, mit der Ausnahme, dass die Bestimmungen von <on:click={() => goToSection(threeTwo)}>Vorgeschriebene Strafen</h4> außer Kraft treten, wenn der derzeitige Commissioner sein Amt niederlegt.</p>
